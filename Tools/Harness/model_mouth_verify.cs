...
void Next(string message) {
    ...
    ScreenCapture.CaptureScreenshot("Artifacts/model-sweep/final-mouth-check-" + stage + ".png");
    stage++;
...
void Finish(string error) {
    ...
    System.IO.File.WriteAllLines("Artifacts/model-sweep/final-mouth-controls.txt", rows);
}
tick = () => {
    try {
