...
namespace GardenSnake.Garden
{
    ...
    /// wildlife were each doing for themselves: attaching to the garden's beat channel, and turning
    /// a distant beat into a delay and a diminished strength.
    /// <para>
    ...
    {
        protected virtual void OnEnable() => GardenBeats.Struck += React;

        protected virtual void OnDisable() => GardenBeats.Struck -= React;
